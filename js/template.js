...
templates['dialog.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "                    <button type=\"button\" class=\"btn btn-secondary confirm-btn\" data-dismiss=\"modal\">"
    + container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.confirmOptions : stack1)) != null ? stack1.text : stack1), depth0))
    + "</button>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.escapeExpression, alias3=container.lambda;

  return "<div class=\"modal fade\" id=\""
    + alias2(((helper = (helper = helpers.contentSelector || (depth0 != null ? depth0.contentSelector : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"contentSelector","hash":{},"data":data}) : helper)))
    + "\" tabindex=\"-1\" role=\"dialog\">\n    <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <h5 class=\"modal-title\">"
    + alias2(alias3(((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.title : stack1), depth0))
    + "</h5>\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                    <span aria-hidden=\"true\">&times;</span>\n                </button>\n            </div>\n            <div class=\"modal-body\">\n                <div class=\"row\">\n                    <div class=\"col-md-12\">\n                        <b><div class=\"modal-msg\">"
    + alias2(alias3(((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.message : stack1), depth0))
    + "</div></b>\n                    </div>\n                </div>\n            </div>\n            <div class=\"modal-footer\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = ((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.confirmOptions : stack1)) != null ? stack1.isConfirm : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
